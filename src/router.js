...
export const routes = [{
    ...
    children: [{
        ...
        path: '/weChatMenuManage',
        name: '微信菜单管理',
        component: tcRightMain,
        isParent: true, //二级菜单
        redirect: '/weChatMenuManage/menuSetting',
        children: [{
            path: '/weChatMenuManage/menuSetting',
            name: '菜单设置',
            component: resolve => require(['@/views/weChatManage/WeChatMenuSetting'], resolve)
        }]
    }]
}, {
    path: '/userManage',
